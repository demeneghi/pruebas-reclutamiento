# Correcciones de reactivos

## Fuente

No hay cuadernillo externo: los reactivos salen de `fuentes/generar_reactivos.py`. Aquí se registran los cambios que salieron de revisar los reactivos generados contra `integridad-psicometrica.md`, con su motivo.

## Revisión visual de los 60 reactivos

| Reactivo | Cambio | Motivo |
|---|---|---|
...
| C8, D8 | Figura de la esquina más grande | Círculo, cuadrado y estrella se confundían a ese tamaño |
| D5 | El distractor de relleno con rayas se cambió por uno de tamaño | La figura interior no se distinguía sobre el rayado |
| Serie E | Punto central más grande | Una opción que solo difiere por el punto debe distinguirse a simple vista |
